...
#include "../SequenceToArrayDemo/cppclass.h"
...
QT_MOC_LITERAL(1, 9, 13), // "qmlArrayToCpp"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 16), // "QVector<QString>"
QT_MOC_LITERAL(4, 41, 6), // "vector"
QT_MOC_LITERAL(5, 48, 15) // "retrieveStrings"

    },
    "CppClass\0qmlArrayToCpp\0\0QVector<QString>\0"
    "vector\0retrieveStrings"
};
...
void CppClass::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->qmlArrayToCpp((*reinterpret_cast< QVector<QString>(*)>(_a[1]))); break;
        case 1: { QVector<QString> _r = _t->retrieveStrings();
