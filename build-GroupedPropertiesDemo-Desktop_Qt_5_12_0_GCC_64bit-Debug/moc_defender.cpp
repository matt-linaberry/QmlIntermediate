...
#include "../GroupedPropertiesDemo/defender.h"
...
struct qt_meta_stringdata_Defender_t {
    QByteArrayData data[1];
    char stringdata0[9];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Defender_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Defender_t qt_meta_stringdata_Defender = {
    {
QT_MOC_LITERAL(0, 0, 8) // "Defender"
...
QT_INIT_METAOBJECT const QMetaObject Defender::staticMetaObject = { {
    &Player::staticMetaObject,
    qt_meta_stringdata_Defender.data,
    qt_meta_data_Defender,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Defender::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Defender.stringdata0))
